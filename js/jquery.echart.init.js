    ...
    Echart.dashboardEcharts = function () {
        ...
        if ($("#platform_type_dates_donut").length) {
            ...
            var option_dt = {
                ...
                options: [
                    {
                        color: ['#efc213', '#eb7c11', '#f23e12', '#82cf0b', '#dae84f'],
                        title: {
                            text: '',
                            subtext: ''
                        },
                        ...
                        legend: {
                            ...
                            orient: 'vertical',
                            padding: 0,
                            data: ['ขยะ', 'ชีวมวล', 'อื่นๆ', 'ก๊าซชีวภาพ', 'พลังงานแสงอาทิตย์']
                        },
                        toolbox: {
                            show: false,
                        ...
                        series: [
                            {
                                ...
                                data: [{value: 35, name: 'ขยะ'}, {value: 16, name: 'ชีวมวล'}, {value: 27, name: 'อื่นๆ'}, {value: 29, name: 'ก๊าซชีวภาพ'}, {value: 12, name: 'พลังงานแสงอาทิตย์'}]
                            }
                        ]
                    },
                    {
                        series: [
                            {
                                name: '05-16',
                                type: 'pie',
                                data: [{value: 42, name: 'ขยะ'}, {value: 51, name: 'ชีวมวล'}, {value: 39, name: 'อื่นๆ'}, {value: 25, name: 'ก๊าซชีวภาพ'}, {value: 9, name: 'พลังงานแสงอาทิตย์'}]
                            }
                        ]
                    },
                    {
                        series: [
                            {
                                name: '04-16',
                                type: 'pie',
                                data: [{value: 29, name: 'ขยะ'}, {value: 16, name: 'ชีวมวล'}, {value: 24, name: 'อื่นๆ'}, {value: 19, name: 'ก๊าซชีวภาพ'}, {value: 5, name: 'พลังงานแสงอาทิตย์'}]
                            }
                        ]
                    },
                ] // end options object
